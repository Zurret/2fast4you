              <td width="100%" align="center" valign="top">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td width="100%">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <form action="index.php?c=sponsoren&d=fireit&sid={SPONSOR_VLU_SID}" method="POST">
                      <tr>
                      ...
                      <tr>
                        <td width="50%" align="right">{SPONSOR_ENDE}</td>
                        <td width="50%" align="left">&nbsp;{SPONSOR_VLU_ENDE}</td>
                      </tr>
                      <tr>
                        <td width="50%" align="right">{SPONSOR_WINS}</td>
                        <td width="50%" align="left">&nbsp;{SPONSOR_VLU_WINS}</td>
                      </tr>
                      <tr>
                        <td width="100%" align="center" colspan="2" height="30"><input type="submit" value="{SPONSOR_BTN_FIREVERTRAG}" class="button" onClick="return confirm('Wirklich einen Vertrag mit diesem Sponsor abschliessen?'); submit();"></td>
                      </tr>
                      </form>
                    </table>
                    </td>
